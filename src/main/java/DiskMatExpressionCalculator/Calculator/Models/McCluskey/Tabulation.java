...
public class Tabulation {
    ...
    private static boolean checkEmpty(Map<Integer, List<Implicant>> nextImplicantsByIndex) {
    ...
    private static List<Implicant> getNewImplicants(Map<Integer, List<Implicant>> implicantsByIndex, int index) {
